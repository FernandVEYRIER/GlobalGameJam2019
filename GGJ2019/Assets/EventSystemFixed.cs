...
//public class EventSystemFixed : UIBehaviour
//{
//    private static List<EventSystemFixed> m_EventSystems = new List<EventSystemFixed>();
...
//    /// </summary>
//    public static EventSystemFixed current
//    {
//        get
//        {
//            return EventSystemFixed.m_EventSystems.Count <= 0 ? (EventSystemFixed)null : EventSystemFixed.m_EventSystems[0];
//        }
//        set
//        {
//            int index = EventSystemFixed.m_EventSystems.IndexOf(value);
//            if (index < 0)
//                return;
//            EventSystemFixed.m_EventSystems.RemoveAt(index);
//            EventSystemFixed.m_EventSystems.Insert(0, value);
//        }
//    }
...
//    /// <summary>
//    ///   <para>Flag to say whether the EventSystem thinks it should be paused or not based upon focused state.</para>
//    /// </summary>
...
//        }
//        raycastResults.Sort(EventSystemFixed.s_RaycastComparer);
//    }
...
//    {
//        base.OnEnable();
//        EventSystemFixed.m_EventSystems.Add(this);
//    }
...
//        }
//        EventSystemFixed.m_EventSystems.Remove(this);
//        base.OnDisable();
//    }
