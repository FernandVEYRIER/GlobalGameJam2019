...
namespace UnityTools
{
    namespace SceneManagement
    {
        public class SceneManager : Singleton<SceneManager>
        {
            ...
            {
                if (m_LevelCollectionEditor == null || m_LevelCollectionEditor.Count == 0 || m_CurrentLevel >= m_LevelCollectionEditor.Count - 1)
                    return;
            ...
            {
                if (m_LevelCollectionEditor == null || m_LevelCollectionEditor.Count == 0 || m_CurrentLevel <= 0)
                    return;
                LoadLevel(m_LevelCollectionEditor[--m_CurrentLevel]);
            }

            public void LoadLevelIndex(int idx)
            {
